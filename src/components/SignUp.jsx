import { FiUser, FiMail, FiLock, FiEye, FiEyeOff, FiChevronDown, FiBriefcase } from "react-icons/fi";
...
const Signup = () => {
    ...
    const[phoneNumber,setPhoneNumber] = us
    ...
    return (
        <div className="relative min-h-screen w-full overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12">
                ...
                <div className="w-full max-w-md bg-white/10 backdrop-blur-lg rounded-xl shadow-xl overflow-hidden border border-blue-500/50">
                        ...
                        <form onSubmit={handleForm} className="space-y-5">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input value={username} onChange={handleUsername} type="text" className="w-full pl-10 pr-4 py-3 bg-white/20 text-white border border-blue-500/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"   required />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input  value={email} onChange={handleEmail} type="email" className="w-full pl-10 pr-4 py-3 bg-white/20 text-white border border-blue-500/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" required
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input value={password} onChange={handlePassword} type={showPassword ? "text" : "password"} className="w-full pl-10 pr-10 py-3 bg-white/20 text-white border border-blue-500/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" required />
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none"><FiLock className="w-5 h-5 text-blue-200" /></div>
                                    <input value={confirmPassword} onChange={handleConfirmPassword} type={showConfirmPassword ? "text" : "password"}  className="w-full pl-10 pr-10 py-3 bg-white/20 text-white border border-blue-500/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" required
                                    />
  ...
  <div className="relative">
    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
      <FiBriefcase className="w-5 h-5 text-blue-200" />
    </div>
    <select
      value={role}
      onChange={handleRole}
      id="role"
      className="w-full pl-10 pr-10 py-3 bg-white/20 text-white border border-blue-500/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition appearance-none"
      required
    >
      <option value="" disabled className="bg-gray-800">Select your role</option>
      <option value="SUPPLY_MANAGER" className="bg-gray-800">Supply Manager</option>
      <option value="PROJECTS_MANAGER" className="bg-gray-800">Projects Manager</option>
      <option value="FINANCE_MANAGER" className="bg-gray-800">Finance Manager</option>
      <option value="HUMAN_RESOURCE_MANAGER" className="bg-gray-800">Human Resource Manager</option>
    </select>
    <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
      <FiChevronDown className="w-5 h-5 text-blue-200" />
    </div>
  </div>
</div>
                            ...
                            <div className="flex items-start">
                                <div className="flex items-center h-5">
                                    <input
                                        ...
                                        type="checkbox"
                                        className="w-4 h-4 text-blue-300 border-blue-500/50 rounded focus:ring-blue-500 bg-white/20"
                                        required
                                    />
                                </div>
                            ...
                            <button 
                                type="submit" 
                                className={`w-full py-3 px-4 text-white font-bold rounded-lg shadow-lg transition-all duration-300 transform ${
                                    isHovered 
                                        ? 'bg-blue-600' 
                                        : 'bg-gradient-to-r from-blue-500 to-emerald-500 scale-100'
                                }`}
                ...
                <div className="mt-8 text-center">
                    <p className="text-blue-100 text-sm">
                        &copy; {new Date().getFullYear()} Building Kenya. All rights reserved.
                    </p>
                </div>
            </div>
        </div>
